...
@Import({ TodoApiThymeleafMybatis3EnvConfig.class })
public class TodoApiThymeleafMybatis3InfraConfig {

    /**
     * Configure {@link SqlSessionFactory} bean.
     * @param dataSource DataSource
     * @see com.example.todo.config.app.TodoApiThymeleafMybatis3EnvConfig#dataSource()
