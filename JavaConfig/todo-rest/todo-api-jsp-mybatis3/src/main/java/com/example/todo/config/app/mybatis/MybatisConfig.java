package com.example.todo.config.app.mybatis;
...
public class MybatisConfig {
    ...
    private static void setTypeAliases(TypeAliasRegistry typeAliasRegistry) {
        typeAliasRegistry.registerAliases("com.example.todo.domain.model");
        typeAliasRegistry.registerAliases("com.example.todo.domain.repository");
        // typeAliasRegistry.registerAliases("com.example.todo.infra.mybatis.typehandler");
    }
    ...
    private static void setTypeHandlers(TypeHandlerRegistry typeHandlerRegistry) {
        // typeHandlerRegistry.register("com.example.todo.infra.mybatis.typehandler");
    }
}
