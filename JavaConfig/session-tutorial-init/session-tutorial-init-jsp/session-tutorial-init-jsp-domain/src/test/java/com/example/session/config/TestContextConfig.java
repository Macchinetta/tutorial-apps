...
import com.example.session.config.app.SessionTutorialInitJspDomainConfig;
...
@Import({ SessionTutorialInitJspDomainConfig.class })
public class TestContextConfig {
     ...
     * @see com.example.session.config.app.SessionTutorialInitJspEnvConfig#dataSource()
