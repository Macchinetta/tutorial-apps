...
import com.example.session.config.app.SessionTutorialCompleteThymeleafDomainConfig;
...
@Import({ SessionTutorialCompleteThymeleafDomainConfig.class })
public class TestContextConfig {
     ...
     * @see com.example.session.config.app.SessionTutorialCompleteThymeleafEnvConfig#dataSource()
