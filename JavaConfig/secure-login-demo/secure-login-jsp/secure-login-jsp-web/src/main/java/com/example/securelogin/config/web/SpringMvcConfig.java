...
import com.example.securelogin.app.common.interceptor.PasswordExpirationCheckInterceptor;
...
public class SpringMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addPasswordExpirationCheckInterceptor(registry, passwordExpirationCheckInterceptor());
    }
    ...
    /**
     * Add PasswordExpirationCheckInterceptor to interceptors.
     * @param registry {@link InterceptorRegistry}
     * @param interceptor {@link HandlerInterceptor}
     */
    private void addPasswordExpirationCheckInterceptor(InterceptorRegistry registry,
            HandlerInterceptor interceptor) {
        registry.addInterceptor(interceptor).addPathPatterns("/**")
                .excludePathPatterns("/password/**", "/reissue/**", "/resources/**", "/*/*.html");
    }

    /**
     * Configure {@link PasswordExpirationCheckInterceptor} bean.
     * @return Bean of configured {@link PasswordExpirationCheckInterceptor}
     */
    @Bean
