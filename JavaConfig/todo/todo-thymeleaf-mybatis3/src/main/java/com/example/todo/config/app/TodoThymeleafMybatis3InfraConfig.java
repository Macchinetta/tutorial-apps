...
@Import({TodoThymeleafMybatis3EnvConfig.class})
public class TodoThymeleafMybatis3InfraConfig {

    /**
     * Configure {@link SqlSessionFactoryBean} bean.
     * @param dataSource DataSource
     * @see com.example.todo.config.app.TodoThymeleafMybatis3EnvConfig#dataSource()
