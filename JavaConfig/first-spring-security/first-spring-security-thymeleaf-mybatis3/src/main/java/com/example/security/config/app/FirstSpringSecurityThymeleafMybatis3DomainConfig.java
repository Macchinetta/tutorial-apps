...
@ComponentScan(basePackages = {"com.example.security.domain"})
@Import({FirstSpringSecurityThymeleafMybatis3InfraConfig.class, FirstSpringSecurityThymeleafMybatis3CodeListConfig.class})
public class FirstSpringSecurityThymeleafMybatis3DomainConfig {
