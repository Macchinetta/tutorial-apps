...
public class PasswordChangePage extends AuthenticationRequiredPage {
    ...
    public PasswordChangePage changePasswordFailure(String oldPassword, String newPassword,
            String confirmNewPassword) {
        changePassword(oldPassword, newPassword, confirmNewPassword);
        return this;
    }

    public PasswordChangeSuccessPage changePasswordSuccess(String oldPassword, String newPassword,
            String confirmNewPassword) {
        changePassword(oldPassword, newPassword, confirmNewPassword);
