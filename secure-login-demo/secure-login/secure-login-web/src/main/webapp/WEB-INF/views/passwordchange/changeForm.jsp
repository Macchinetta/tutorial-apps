...
<html>
    ...
    <body>
        <div id="wrapper">
            ...
            <form:form action="${f:h(pageContext.request.contextPath)}/password" method="POST" modelAttribute="passwordChangeForm">
                <table>
                    <tr>
                        <th><form:label path="username">Username</form:label></th>
                        <td>${f:h(account.username)} <form:hidden path="username" value="${f:h(account.username)}" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <th><form:label path="oldPassword" cssErrorClass="error-label">Old password</form:label></th>
                    ...
                    <tr>
                        <th><form:label path="confirmNewPassword" cssErrorClass="error-label">New password(Confirm)</form:label></th>
