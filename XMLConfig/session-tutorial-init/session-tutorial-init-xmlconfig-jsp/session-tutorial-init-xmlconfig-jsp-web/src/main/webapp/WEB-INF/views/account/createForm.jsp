...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/vendor/bootstrap-3.0.0/css/bootstrap.css" media="screen, projection" />
    </head>
    <body>
        <div class="container">
                ...
                <form:form action="${pageContext.request.contextPath}/account/create" method="post" modelAttribute="accountCreateForm">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <form:password path="confirmPassword" cssErrorClass="error-input" />
                        ...
                        <tr>
                            ...
                            <td>
                                <fmt:formatDate value="${accountCreateForm.birthday}" pattern="yyyy-MM-dd" var="formattedBirthday" />
